...
//treeAvl.insert(marketFour.getValor(), marketFour);
//treeAvl.insert(marketFive.getValor(), marketFive);
//BNode<Double, MercadoInternacional> nodeMinimum=treeAvl.minimum(treeAvl.getRoot());
...
//	MercadoInternacional findMarket=treeAvl.search(keySearch);	
//	assertEquals(findMarket.getValor(), keySearch);
//	
//	}
